package com.chao.springframework.beans.factory.xml;
...
import com.chao.springframework.beans.factory.support.AbstractBeanDefinitionReader;
import com.chao.springframework.beans.factory.support.BeanDefinitionRegistry;
import com.chao.springframework.context.annotation.ClassPathBeanDefinitionScanner;
...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
    ...
    public void loadBeanDefinitions(Resource resource) throws BeansException {
        try {
            ...
            throw new BeansException("IOException parsing XML decument from " + resource, e);
        }
    }
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (null != componentScan) {
            ...
            if (StrUtil.isEmpty(scanPath)) {
                throw new BeanException("The value of base-package attribute can not be null empty or null");
            }
    ...
    private void scanPackage(String scanPath) {
        String[] bachPackages = StrUtil.splitToArray(scanPath, ',');
        ClassPathBeanDefinitionScanner scanner = new ClassPathBeanDefinitionScanner(getRegistry());
        scanner.doScan(bachPackages);
    }
}
